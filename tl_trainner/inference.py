...
def main():
    with tf.Session() as sess:
        model = inference(sess, r'D:\udacity\final_tl\model\saved_model\2018916_184744')

        data_path = r'D:\udacity\final_tl\test_images\*.png'

        images = glob.glob(data_path)
        X = []
        y = []

        for img_path in images: ### todo: batch 
